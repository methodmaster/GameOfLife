...
public class ApplyRules
{
    ...
    public int[][] Rules(int[][] array)
    {
        ...
        for (int row = 0; row < gridArray.length; row++)
        {
            for (int column = 0; column < gridArray[row].length; column++)
            {
                ...
                // Middle Top Position
                if ((row == 0 && column > 0) && (column < edgeNumber ))
                {
                    aliveNumber = getAliveNeighborsNumber_Middle_TopPosition(gridArray,
                            row,column);
                }

                // Middle Right Position
                if ((row > 0 && column == edgeNumber) && (row < edgeNumber ))
                {
                    aliveNumber = getAliveNeighborsNumber_Middle_RightPosition(gridArray,
                            row,column);
                }

                // Middle Bottom Position
                if ((row == edgeNumber && column > 0) && (column < edgeNumber))
                {
                    aliveNumber = getAliveNeighborsNumber_Middle_BottomPosition(gridArray,
                            row,column);
                }

                // Middle Left Position
                if ((row > 0 && column == 0) && (row < edgeNumber))
                {
                    aliveNumber = getAliveNeighborsNumber_Middle_LeftPosition(gridArray,
                            row,column);
                }
    ...
    private static int getAliveNeighborsNumber_Middle_TopPosition(int[][] array,
                                                                  int currentRowIndex,
                                                                  int currentColumnIndex)
    {
        int aliveNumber = 0;
    ...
    private static int getAliveNeighborsNumber_Middle_RightPosition(int[][] array,
                                                                    int currentRowIndex,
                                                                    int currentColumnIndex)
    {
        int aliveNumber = 0;
    ...
    private static int getAliveNeighborsNumber_Middle_BottomPosition(int[][] array,
                                                                     int currentRowIndex,
                                                                     int currentColumnIndex)
    {
        int aliveNumber = 0;
    ...
    private static int getAliveNeighborsNumber_Middle_LeftPosition(int[][] array,
                                                                   int currentRowIndex,
                                                                   int currentColumnIndex)
    {
        int aliveNumber = 0;
